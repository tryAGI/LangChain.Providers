...
public static class DeepInfraModelProvider
{
    private static Dictionary<DeepInfraModelIds, ChatModelMetadata> Models { get; set; } = new()
    {
        ...
        { DeepInfraModelIds.DeepseekV30324, ToMetadata("deepseek-ai/DeepSeek-V3-0324",163840,3.4000000000000003E-07,8.8E-07)},
        ...
        { DeepInfraModelIds.Gemini25Flash, ToMetadata("google/gemini-2.5-flash",1000000,1.0000000000000001E-07,2.4500000000000003E-06)},
        { DeepInfraModelIds.Gemini25Pro, ToMetadata("google/gemini-2.5-pro",1000000,8.8E-07,7E-06)},
        ...
        { DeepInfraModelIds.LlamaGuard38B, ToMetadata("meta-llama/Llama-Guard-3-8B",131072,0,0)},
        ...
        { DeepInfraModelIds.MultilingualE5LargeInstruct, ToMetadata("intfloat/multilingual-e5-large-instruct",512,0,0)},
