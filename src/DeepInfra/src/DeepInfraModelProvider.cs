...
public static class DeepInfraModelProvider
{
    private static Dictionary<DeepInfraModelIds, ChatModelMetadata> Models { get; set; } = new()
    {
        ...
        { DeepInfraModelIds.Qwen25Coder32BInstruct, ToMetadata("Qwen/Qwen2.5-Coder-32B-Instruct",32768,1.8E-07,1.8E-07)},
        ...
        { DeepInfraModelIds.MythomaxL213B, ToMetadata("Gryphe/MythoMax-L2-13b",4096,8E-08,8E-08)},
        ...
        { DeepInfraModelIds.Qwen257BInstruct, ToMetadata("Qwen/Qwen2.5-7B-Instruct",32768,6E-08,6E-08)},
        ...
        { DeepInfraModelIds.L38BLunarisV1, ToMetadata("Sao10K/L3-8B-Lunaris-v1",8192,5.0000000000000004E-08,5.0000000000000004E-08)},
        ...
        { DeepInfraModelIds.MetaLlama370BInstruct, ToMetadata("meta-llama/Meta-Llama-3-70B-Instruct",8192,3.5E-07,4.0000000000000003E-07)},
