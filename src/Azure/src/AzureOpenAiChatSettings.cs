...
/// </summary>
public class AzureOpenAiChatSettings : ChatSettings
{
    /// <summary>
    /// According: https://platform.openai.com/docs/api-reference/chat/create
    /// </summary>
    public new static AzureOpenAiChatSettings Default { get; } = new()
    {
    ...
    public new static AzureOpenAiChatSettings Calculate(
        ChatSettings? requestSettings,
        ChatSettings? modelSettings,
        ChatSettings? providerSettings)
    {
        var requestSettingsCasted = requestSettings as AzureOpenAiChatSettings;
        var modelSettingsCasted = modelSettings as AzureOpenAiChatSettings;
        var providerSettingsCasted = providerSettings as AzureOpenAiChatSettings;

        return new AzureOpenAiChatSettings
        {
            StopSequences =
