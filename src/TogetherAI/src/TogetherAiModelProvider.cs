...
public static class TogetherAiModelProvider
{
    private static Dictionary<TogetherAiModelIds, ChatModelMetadata> Models { get; set; } = new()
    {
        ...
        { TogetherAiModelIds.MetaLlama38BInstructReference, ToMetadata("meta-llama/Llama-3-8b-chat-hf",8192,2.0000000000000002E-07,2.0000000000000002E-07)},
        { TogetherAiModelIds.MetaLlama3170BInstructTurbo, ToMetadata("meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo",32768,8.8E-07,8.8E-07)},
        { TogetherAiModelIds.MetaLlama318BInstructTurbo, ToMetadata("meta-llama/Meta-Llama-3.1-8B-Instruct-Turbo",32768,1.8E-07,1.8E-07)},
        ...
        { TogetherAiModelIds.MetaLlama31405BInstructTurbo, ToMetadata("meta-llama/Meta-Llama-3.1-405B-Instruct-Lite-Pro",4096,0,0)},
        { TogetherAiModelIds.MetaLlama370BInstructReference, ToMetadata("meta-llama/Llama-3-70b-chat-hf",8192,9.000000000000001E-07,9.000000000000001E-07)},
        ...
        { TogetherAiModelIds.GrypheMythomaxL2Lite13B, ToMetadata("Gryphe/MythoMax-L2-13b-Lite",4096,2.0000000000000002E-07,4.0000000000000003E-07)},
        ...
        { TogetherAiModelIds.LlavaNextMistral7B, ToMetadata("llava-hf/llava-v1.6-mistral-7b-hf",4096,1.8E-07,1.8E-07)},
