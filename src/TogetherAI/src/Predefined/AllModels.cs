...
/// <inheritdoc cref="TogetherAiModelIds.MetaLlama38BInstructReference"/>
/// <param name="provider">Open Router Provider Instance</param>
...
/// <param name="provider">Open Router Provider Instance</param>
public class MetaLlama370BInstructReferenceModel(TogetherAiProvider provider) : TogetherAiModel(provider, TogetherAiModelIds.MetaLlama370BInstructReference);
